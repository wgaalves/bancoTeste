                ...
                <g:each in="${scopeList}">
                    <tr>
                        ...
                        <td class="text-center">
                            <a class="btn btn-primary" href="${createLink(controller:'scope' , action: 'edit' ,params:[id:it.id] )}" >
...
<script >
    $(document).ready(function() {
        var url = "${createLink(controller: 'scope',action: 'delete')}";
